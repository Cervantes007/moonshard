 ...
 */
export function transformAndValidate<T extends CustomObject>(
...
export function transformAndValidate<T extends CustomObject>(
  classType: ClassType<T>,
  somethingToTransform: string | CustomObject | CustomObject[],
  options?: TransformValidationOptions,
): Promise<T> {
 ...
 */
export function transformAndValidateSync<T extends CustomObject>(
  classType: ClassType<T>,
  jsonString: string,
  options?: TransformValidationOptions,
): T | T[]
